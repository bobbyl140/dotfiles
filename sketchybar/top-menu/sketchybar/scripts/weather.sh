...
API_KEY="70471d5a254749e1a4c183719230612" # insert api key here
CITY="14623" # insert city here
...
response_city="$(echo $data | jq -r '.location.name'), $(echo $data | jq -r '.location.region')"
